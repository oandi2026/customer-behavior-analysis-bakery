...
# FIX 1: Change "QUESTION_ID" to "QUESTION ID" to match your uppercase transformation exactly
# FIX 2: Explicitly convert to str() so it successfully matches the dictionary keys
...
if question_id in insights:
    ...
    st.info(f"Insight not available for ID: {question_id}")
