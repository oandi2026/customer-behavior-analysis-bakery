...
insights = {
    ...
    "2a": """The chart shows that many respondents rarely purchase bread for parties. Although the bakery offers custom products such as cakes, low awareness—likely due to limited advertising—reduces demand. Increasing promotion could help customers better recognize these offerings.""",
