...
insights = {
    ...
    "1h3": """"Evening Consumer Insights: Respondents dislike consuming bread as a rice substitute during the evening. Furthermore, respondent critique indicates that traditional moist cakes (kue basah) are less palatable in the evening due to a lack of freshness.""",
    "1h4": """Respondents dislike consuming bread as a rice substitute during the night.""",
    "1h5": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
