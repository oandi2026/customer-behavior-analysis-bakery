...
insights = {
    ...
    "1f": """Consumers also buy bread as souvenirs (gifts). The reason for purchasing bread as a souvenir ranks third, following the reasons for family consumption and for resale. To optimize bread sales for both souvenir and personal consumption purposes, the company should enhance the packaging, for example, by using attractive cardboard boxes designed in the shape of miniature houses with a handle hole on the top side.""",
    "1g": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
    "1h1": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
    "2a": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
    "2a": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
    "2a": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
    "2a": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
    "2a": """The pricing perception is generally positive, indicating that customers find the products affordable. This aligns well with mass-market positioning and supports volume-driven sales strategies.""",
